...
export async function GET(request: NextRequest) {
  try {
    ...
    const releaseQueries = {
      'april': 'project in ("integrator.io", PRE, devops) AND created >= 2025-02-26 AND created <= 2025-04-08 AND issuetype = Bug ORDER BY created DESC',
      'may': 'project in ("integrator.io", PRE, devops) AND created >= 2025-04-08 AND created <= 2025-05-21 AND issuetype = Bug ORDER BY created DESC',
      'july': 'project in ("integrator.io", PRE, devops) AND created >= 2025-05-21 AND created <= 2025-07-01 AND issuetype = Bug ORDER BY created DESC',
      'august': 'project in ("integrator.io", PRE, devops) AND created >= 2025-07-02 AND created <= 2025-08-12 AND issuetype = Bug ORDER BY created DESC'
    };
